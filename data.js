const data = {
  ...
  item6: {
    ...
    third:
      "A partir de una clase solo se puede crear un objeto.",
    fourth:
  ...
  item7: {
    ...
    five:
      "Pueden existir métodos de clase que accedan a variables de clase, pero sólo a las públicas. ",
    answer: 1,
  },
  item8: {
    id: "8",
  ...
  item10: {
    ...
    five:
      "Un getter / setter no es más que otro atributo de la clase que admite parámetros. ",
    answer: 2,
  },
  item11: {
    id: "11",
  ...
  item12: {
    ...
    third: "Sólo si está declarado como público y se accede desde otro método de clase.",
    fourth:
  ...
  item29: {
    ...
    five: "Ninguna de las anteriores es correcta.",
    answer: 4,
  },
  item30: {
    id: "30",
  ...
  item33: {
    ...
    title:
      "Indica cuál de estas afirmaciones es correcta",
    first: "Una superclase es una clase que es implementada por otra",
  ...
  item37: {
    id: "37",
    title: "Es posible que los métodos indiquen en su declaración que pueden lanzar una excepción al método que les llama",
    first: "No pueden hacer tal cosa, no tendría sentido.",
    second: "Pueden hacerlo utilizando la palabra reservada throw.",
  ...
  item38: {
    ...
    title: "Indica la respuesta correcta",
    first:
      "Se puede sobrecargar un método variando los parámetros de entrada.",
    second:
      "Se puede sobrecargar un método variando el tipo de retorno de éste sin variar los parámetros de entrada.",
    third:
      "Un método puede ser sobrecargado en la misma clase o en una subclase utilizando los mismos parámetros.",
    fourth: "Los atributos también pueden ser sobrecargados.",
    five: "Los métodos de clase no pueden ser sobrecargados.",
    answer: 1,
  },
  item39: {
    id: "39",
  ...
  item47: {
    ...
    third: "Una clase solo puede ser instanciada una vez.",
    fourth: "Todas las anteriores son verdaderas.",
    answer: 2,
  },
};
